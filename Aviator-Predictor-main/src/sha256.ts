import { jsSHABase, TWO_PWR_32, H_full, H_trunc, SHA2_K, sha_variant_error, parseInputOption } from "./common";
import {
  packedValue,
...
function roundSHA256(block: number[], H: number[]): number[] {
  ...
  for (t = 0; t < 64; t += 1) {
    ...
    T1 = safeAdd_32_5(h, sigma1_32(e), ch_32(e, f, g), SHA2_K[t], W[t]);
